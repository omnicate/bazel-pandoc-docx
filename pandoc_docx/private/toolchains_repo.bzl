...
# By default all these toolchains are registered by the pandoc_docx_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:pandoc_docx_toolchain",
    toolchain_type = "@com_wgtwo_rules_pandoc_docx//pandoc_docx:toolchain_type",
)
""".format(
            platform = platform,
