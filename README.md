...
1. search for "com_wgtwo_rules_pandoc_docx" and replace with the name you'll use for your workspace
1. search for "omnicate" and replace with GitHub org
1. search for "pandoc_docx" and replace with the language/tool your rules are for
1. rename directory "pandoc_docx" similarly
